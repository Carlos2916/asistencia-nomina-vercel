  ...
  if (view === "alta_empleado") {
    return (
      <div className="min-h-screen bg-green-50 p-6">
        <button onClick={() => setView("dashboard")} className="mb-4 text-green-700 underline">
          ← Volver al inicio
        </button>
        ...
        <div className="grid gap-4 max-w-xl">
          <input
            ...
            onChange={(e) => setEmpleado({ ...empleado, numero_empleado: e.target.value })}
          />
          <input
            type="text"
          ...
          <select
            ...
            onChange={(e) => setEmpleado({ ...empleado, sucursal: e.target.value })}
          >
            {sucursales.map((suc) => (
          ...
          <input
            ...
            className="p-2 border rounded"
            value={empleado.sueldo_quincenal}
            onChange={(e) => setEmpleado({ ...empleado, sueldo_quincenal: e.target.value })}
          />
          <input
            type="number"
            placeholder="Horas extras (MXN)"
            className="p-2 border rounded"
            value={empleado.horas_extras}
            onChange={(e) => setEmpleado({ ...empleado, horas_extras: e.target.value })}
          />
          <input
            type="text"
            placeholder="Puesto"
